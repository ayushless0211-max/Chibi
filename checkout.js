    ...
    if (checkoutForm) {
        checkoutForm.onsubmit = async (e) => {
            ...
            try {
                ...
                const orderRes = await fetch('https://anime-backend-6mra.onrender.com/api/create-payment-order', {
                    method: 'POST',
                ...
                const paymentOptions = {
                    ...
                    "handler": async function (response) {
                        ...
                        const verifyRes = await fetch('https://anime-backend-6mra.onrender.com/api/verify-payment', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json' },
                            body: JSON.stringify({
                                customerDetails,
